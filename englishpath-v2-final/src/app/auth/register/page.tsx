...
export default function RegisterPage() {
  ...
  async function handleGoogle() {
    ...
    if (error) { toast.error("Đăng ký Google thất bại"); setLoading(false); }
  }
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="card p-8 max-w-md w-full text-center">
        ...
        <p className="text-gray-500 text-sm mb-6">
          Chúng tôi đã gửi link xác nhận đến <strong>{email}</strong>. Nhấp vào link để kích hoạt tài khoản.
        </p>
          ...
          <div className="card p-8">
            ...
            <div className="mt-4 p-3 bg-brand-50 rounded-xl">
              <p className="text-xs text-brand-700 text-center">
                🎁 Tài khoản Free bao gồm: A1 + A2 đầy đủ · 10 AI messages/tháng · Flashcard SRS
              </p>
            </div>
          </div>
        </div>
